...
@WebServlet("/GetDataAndGoToJSP.do")
public class GetDataAndGoToJSP extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("ShowUpdateItem.jsp").forward(request, response);
